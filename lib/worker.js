 ...
 * @property {Map<Activity.Sid, Activity>} activities - The list of possible states a {@link Worker} can be
 ...
 * @property {Map<Channel.Sid, Channel>} channels - The list of available {@link Channel}s
 ...
 * @property {Map<Reservation.Sid, Reservation>} reservations - A list of pending {@link Reservation}s
 ...
 * @returns {Promise<Map<Task.Sid, Task>>} - Rejected if unable to get the {@link Task}s
 */
...
/**
 * The {@EventBridgeSignaling} has lost the websocket connection
